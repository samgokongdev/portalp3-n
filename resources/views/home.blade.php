                        ...
                        <div class="w-chart">
                            ...
                            <div class="w-chart-section total-visits-content">
                                <div class="w-detail">
                                    ...
                                    <p class="w-stats">Rp 421,123,563,123</p>
                                </div>
                            </div>
                        ...
                        <div class="w-chart">
                            ...
                            <div class="w-chart-section total-visits-content">
                                <div class="w-detail">
                                    ...
                                    <p class="w-stats">Rp 12,456,852,679</p>
                                </div>
                            </div>
                            ...
                            <form class="simple-example" action="" novalidate>
                                <div class="form-row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input maxlength="15" type="text" class="form-control" id="fullName"
